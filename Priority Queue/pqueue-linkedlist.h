...
private:
	...
	//variables
	Cell* head; //head of linked list
	int length; //this variable save size of linked list

	//functions
	int findIndex(string newVal); //sub function of enqueue, which find index where new element will add
};
